...
app_name='board'
urlpatterns = [
    path('customer/notice/', views.notice,name='notice'),                # 게시판리스트
    path('<str:b_no>/event/event_view/', views.event_view,name='event_view'),  # 이벤트뷰
    
    path('event/comlist/', views.comlist,name='comlist'),  # 댓글리스트
    ...
    # path('event/commcancel/', views.commcancel,name='commcancel'),  #댓글 수정저장
